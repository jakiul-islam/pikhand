            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="input-group">
                  ...
                  id="addon-wrapping">Create policies page</span><br>
                  <textarea id="Policiesdescription" class="description"></textarea>
                </div>
                <br>

                <div class="modal-footer">
                <button type="button" id="insertclose" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" id="InsertPolicies" name="InsertPolicies"
                class="btn btn-primary">Insert Policies</button>
              </div>
            </div>
          </div>
        </div>
