...
<html lang="en">
  ...
  <body>
   ...
   <!-- all model site -->
        ...
        <script  src="{{ asset('public/js/Admin/admin/admin-list.js') }}"></script>
        <script  src="{{ asset('public/js/Admin/admin/admin-page-list.js') }}"></script>
        <script  src="{{ asset('public/js/Admin/admin/admin-profile-details.js') }}"></script>
  </body>
</html>