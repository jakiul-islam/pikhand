    ...
    @media (min-width: 400px) {
      ...
      <div class="offcanvas-body cart" style="height:65%; overflow:auto;">
       ...
       position:absolute; bottom:0px; color:#ffffff;'>
         ...
         @else
            <button class="btn btn-outline-success" type="button" data-bs-toggle="modal" data-bs-target="#categoryForm" id='chackoutbutton' style='display:none; position:absolute; right:6px; bottom:5px;' onclick="loginOrsignup()">LOGIN/SIGNUP</button>
         @endif
       </div>
       <!-- href='/home/chackout' -->
     </div>
